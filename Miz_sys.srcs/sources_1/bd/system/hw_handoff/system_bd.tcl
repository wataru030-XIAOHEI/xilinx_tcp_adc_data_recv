...
proc create_root_design { parentCell } {
  ...
  set adc_data_0 [ create_bd_port -dir I -from 15 -to 0 adc_data_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#UART 0#UART 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#SD 0#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO} \
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins adc_0/M00_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets S_AXIS_1] [get_bd_intf_pins adc_0/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets S_AXIS_1]
set_property HDL_ATTRIBUTE.DEBUG_IN_BD {true} [get_bd_intf_nets S_AXIS_1]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports gpio_key] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  connect_bd_net -net In0_0_1 [get_bd_ports ENET0_GMII_RXD_0] [get_bd_pins xlconcat_2/In0]
  connect_bd_net -net adc_0_adc_clk_o [get_bd_ports adc_clk_o_0] [get_bd_pins adc_0/adc_clk_o]
  connect_bd_net -net adc_0_m00_axis_tdata [get_bd_pins adc_0/m00_axis_tdata] [get_bd_pins axis_data_fifo_0/s_axis_tdata]
  connect_bd_net -net adc_0_m00_axis_tlast [get_bd_pins adc_0/m00_axis_tlast] [get_bd_pins axis_data_fifo_0/s_axis_tlast]
  connect_bd_net -net adc_0_m00_axis_tstrb [get_bd_pins adc_0/m00_axis_tstrb] [get_bd_pins axis_data_fifo_0/s_axis_tstrb]
  connect_bd_net -net adc_0_m00_axis_tvalid [get_bd_pins adc_0/m00_axis_tvalid] [get_bd_pins axis_data_fifo_0/s_axis_tvalid]
  connect_bd_net -net adc_data_0_1 [get_bd_ports adc_data_0] [get_bd_pins adc_0/adc_data]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins adc_0/gpio_tri_o_0] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axis_data_fifo_0_s_axis_tready [get_bd_pins adc_0/m00_axis_tready] [get_bd_pins axis_data_fifo_0/s_axis_tready]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  ...
  connect_bd_net -net s_axis_aclk_1 [get_bd_ports s_axis_aclk] [get_bd_pins adc_0/adc_clk_i] [get_bd_pins adc_0/m00_axis_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net s_axis_aresetn_1 [get_bd_ports s_axis_aresetn] [get_bd_pins adc_0/m00_axis_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_ports ENET0_GMII_TXD_0] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins processing_system7_0/ENET0_GMII_RXD] [get_bd_pins xlconcat_2/dout]
