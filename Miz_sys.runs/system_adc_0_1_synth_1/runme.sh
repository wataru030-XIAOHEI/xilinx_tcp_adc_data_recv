...
HD_PWD='C:/Users/wataru/Desktop/addr/Miz_sys/Miz_sys/Miz_sys.runs/system_adc_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_adc_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_adc_0_1.tcl
